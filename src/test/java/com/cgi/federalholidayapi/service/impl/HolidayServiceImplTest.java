...
public class HolidayServiceImplTest {
    ...
    void shouldReturnHolidaysByCountry() {
        ...
        List<HolidayResponse> response = holidayService.getHolidaysByCountry(Country.CANADA);
        assertEquals(1, response.size());
    ...
    void shouldUpdateHolidaySuccessfully() {
        ...
        HolidayRequest request = new HolidayRequest(Country.USA, "New Name", LocalDate.of(2026, 12, 25));
    ...
    void shouldThrowExceptionWhenHolidayNotFoundForUpdate() {
        ...
        assertThrows(
                ...
                () -> holidayService.updateHoliday(100L,
                        new HolidayRequest(Country.USA, "Test", LocalDate.now()))
        );
    }
